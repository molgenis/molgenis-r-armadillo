...
#> Warning in if (nchar(value) == 0) {: the condition has length > 1 and only the first element will be used
#> Warning in if (value == "") {: the condition has length > 1 and only the first element will be used
#> Attempting to whitelist package [ 'MolgenisArmadillo' ]
#> Package [ 'MolgenisArmadillo' ] added to the whitelist
