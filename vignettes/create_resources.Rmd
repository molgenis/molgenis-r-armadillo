...
#> Error in .get_info(server): Bad Gateway (HTTP 502). Failed to fetch server info.
```
...
#> 	/var/folders/sy/d5l5fdyj6z98mgclrl_bbkzr0000gn/T//Rtmp2sXukB/downloaded_packages
library(resourcer)
...
`https://armadillo3-01.molgeniscloud.org/storage/projects/omics/objects/ewas%2Fgse66351_1.rda`. Here the URL is
`https://armadillo3-01.molgeniscloud.org`, the project name is `omics`, the folder is `ewas` and the name of the
