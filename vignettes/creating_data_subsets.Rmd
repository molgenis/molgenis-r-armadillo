...
#> Error in library(MolgenisArmadillo): there is no package called 'MolgenisArmadillo'
```
...
#> Error in armadillo.login("https://armadillo.test.molgenis.org", "https://armadillo-minio.test.molgenis.org"): could not find function "armadillo.login"
```
...
#> Error in armadillo.subset_definition(vars = "data/subset/vars.csv", metadata = "data/subset/meta.csv"): could not find function "armadillo.subset_definition"
subset_definition
#> Error in eval(expr, envir, enclos): object 'subset_definition' not found
```
...
#> Error in armadillo.subset(source_project = "gecko", new_project = "study1", : could not find function "armadillo.subset"
not_available
