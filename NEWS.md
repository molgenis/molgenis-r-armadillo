...
Defunct: armadllo.get_token is defunct, from now on use armadillo.get_credentials
Fix: return error message if attemping to log in without admin rights (previously failed silently)
