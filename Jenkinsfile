    ...
    stages {
        stage('Prepare') {
            steps {
                ...
                sh "git fetch --tags"
                container('r') {
                    sh "install2.r --repo https://cloud.r-project.org devtools pkgdown markdown rmarkdown mockery httr urltools xml2 arrow MolgenisAuth DSMolgenisArmadillo git2r ellipsis vctrs covr"
