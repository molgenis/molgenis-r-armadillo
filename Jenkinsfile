        ...
        stage('Prepare') {
            ...
            steps {
                ...
                container('r') {
                    ...
                    sh "install2.r --repo https://cloud.r-project.org devtools pkgdown markdown rmarkdown mockery httr urltools xml2 aws.iam aws.s3 arrow MolgenisAuth DSMolgenisArmadillo"
