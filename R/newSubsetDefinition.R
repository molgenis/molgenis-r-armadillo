...
#'
#' @export
newSubsetDefinition <- function(vars = NULL, metadata = NULL){
...
stop(paste0("The following folders are specified in your variables to subset, but don't exist in your
  metadata:  ", 
...
stop(paste0("The following tables are specified in your variables to subset, but don't exist in your
  metadata:  ", 
